  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          backgroundColor: isDarkTheme ? Constants.chatGPTDarkCardColor : Colors.white,
          title: Center(
            child: Text('Comments', style: TextStyle(color: color),),
          ),
          titleSpacing: -15,
          actions: [
            Padding(
              ...
              child: CircleAvatar(
                key: UniqueKey(),
                radius: 15,
                backgroundImage: CachedNetworkImageProvider(widget.postData[Constants.senderPic],
      ...
      body: SafeArea(
        child: Column(
          children: [
             Expanded(
              child: ChatList(fromScreen: FromScreen.commentsScreen, postData: widget.postData,),
            ),
            ...
            BottomChatField(fromScreen: FromScreen.commentsScreen, postData: widget.postData,),
          ],
        ),
      ),
    );
