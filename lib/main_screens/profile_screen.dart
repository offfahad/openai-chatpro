                        ...
                        children: [
                          ...
                          IntrinsicHeight(
                            child: Row(
                              ...
                              children: <Widget> [
                                Expanded(child: buildButton(context: context, value: '5', text: 'Shared',)),

                                SizedBox(
                                  height: 24,
                                  child: VerticalDivider(color: color,),
                                ),
                                Expanded(child: buildButton(context: context, value: '18', text: 'Following',)),
                                SizedBox(
                                  height: 24,
                                  child: VerticalDivider(color: color,),
                                ),
                                Expanded(child: buildButton(context: context, value: '25', text: 'Followers',)),
                              ],
                            ),
                          ),
                          ...
                          SwitchListTile(
                            title: const Text('Speech', style: TextStyle(fontWeight: FontWeight.normal),),
                              secondary: Icon(chatProvider.shouldSpeak ? Icons.mic : Icons.mic_off),
