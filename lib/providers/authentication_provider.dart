...
import 'package:open_ai_chatgpt/model/user_model.dart';
...
class AuthenticationProvider extends ChangeNotifier {
  ...
  void saveUserDataToFireStore({
    ...
    try{
      ...
      String imageUrl = await storeFileImageToStorage('${Constants.userImages}/$uid.jpg', fileImage);
  ...
  Future<bool> checkUserExist() async {
    DocumentSnapshot documentSnapshot = await firebaseFirestore.collection(Constants.users).doc(_uid).get();
  ...
  Future getUserDataFromFireStore() async {
    await firebaseFirestore
        .collection(Constants.users)
        .doc(firebaseAuth.currentUser!.uid).get().then((DocumentSnapshot documentSnapshot){
          _userModel = UserModel(
