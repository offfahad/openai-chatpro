...
import 'package:open_ai_chatgpt/service/api_service.dart';
    ...
    try{
      ...
      if(isLiked) {
        ...
        await firebaseFirestore
            ...
            .doc(postData[Constants.postId])
            .update({
          Constants.likes: FieldValue.increment(1)
        });
  ...
  Future<void> sendComment({
    ...
    try {
      ...
      await firebaseFirestore
          ...
          .doc(postData[Constants.postId])
          .update({
        Constants.comments: FieldValue.increment(1)
      });
