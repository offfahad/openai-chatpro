...
class BottomChatField extends StatefulWidget {
  const BottomChatField({Key? key, required this.fromScreen, this.postData,}) : super(key: key);
  ...
  Widget build(BuildContext context) {
          ...
          Expanded(
            child: Padding(
              ...
              decoration: InputDecoration.collapsed(
                  hintText: widget.fromScreen == FromScreen.aIChatScreen ? 'How can i help you?' : 'Type something...',
    ...
    if(widget.fromScreen == FromScreen.aIChatScreen) {
      ...
      if(context.read<ChatProvider>().isTyping){
        showSnackBar(context: context, content: 'Please wait for a response');
        return;
      }
      ...
      context.read<ChatProvider>().sendComment(
          ...
          IconButton(
            onPressed: (){
              ...
              ? Icons.send
              : widget.fromScreen == FromScreen.aIChatScreen
              ? Icons.mic : Icons.send,color: color,),)
        ],
      ),
    );
  }
