    ...
    return senderId == userModel.uid ?
      ...
      child: Column(
        ...
        children: [
          ...
          Stack(
            children: [
              Padding(
                padding: const EdgeInsets.only(left: 10.0, right: 10, top: 5, bottom: 20),
                child: Text(element[Constants.message], style: const TextStyle(fontSize: 16, color: Colors.white)),
              ),
              Positioned(
                  bottom: 4,
                  right: 10,
                  child: Text(time, style: const TextStyle(fontSize: 13, color: Colors.white60),),
              )
            ],
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(right: 8.0, top: 4.0, left: 8.0),
            child: Text(element[Constants.senderName],
          ...
          Stack(
            children: [
              Padding(
                padding: const EdgeInsets.only(left: 10.0, right: 30, top: 5, bottom: 20),
                child: Text(element[Constants.message], style: const TextStyle(fontSize: 16, color: Colors.black)),
              ),
              Positioned(
                bottom: 4,
                left: 10,
                child: Text(time, style: const TextStyle(fontSize: 13, color: Colors.black54),),
              )
            ],
